        ...
        <div class="row text-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-title">Awards</h1>
                </div>
...
<section class="awards-style1 space" data-bg-src="home/img/awards/awards-style1-bg.png">
    <img src="home/img/icons/plain-globe.png" alt="plain-globe" class="about-icon-1 animate-parachute" />
    <img src="home/img/icons/map.png" alt="plain-globe" class="about-icon-2 animate-parachute" />
        ...
        <div class="row g-2 g-lg-4 award-box-style1__row">
                ...
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon">
                            <img src="home/img/awards/awd-2024.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                ...
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awd-2023.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awd-2022.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awd-2021.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived in happy award in <strong>2021</strong>
                            </p>
                        </div>
                    </div>
                </div>
             ...
             <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awd-2020.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived in happy award in <strong>2020</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awd-2016.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived in happy award in <strong>2016</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awdBB-2020.png" alt="award" width="132" height="103"
                                >
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awdBBTD-2020.png" alt="award" width="132" height="103"
                                >
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
                            <h6 class="text-capitalize ff-rubik fw-semibold">
                                Best of the Best Tripadvisor Award
                            </h6>
                            <img src="home/img/awards/award-box-right-wings.png" alt="award-box-right-wings" />
                        </div>
                        <div class="award-box-body text-center">
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/awdTD-2019.png" alt="award" width="132" height="103"
                                >
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived in happy award in <strong>2019</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-5.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2022</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-1.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2021</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-2.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2020</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-3.png" alt="award" width="132" height="103"
                                class="awd-icon">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
                            <h6 class="text-capitalize ff-rubik fw-semibold">
                                Agoda Gold Circle Winner Award
                            </h6>
                            <img src="home/img/awards/award-box-right-wings.png" alt="award-box-right-wings" />
                        </div>
                        <div class="award-box-body text-center">
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2019</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-6.png" alt="award" width="132" height="103">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
                            <h6 class="text-capitalize ff-rubik fw-semibold">
                                Yatra Customer Choice Award
                            </h6>
                            <img src="home/img/awards/award-box-right-wings.png" alt="award-box-right-wings" />
                        </div>
                        <div class="award-box-body text-center">
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-12.png" alt="award" width="132" height="103">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-8.png" alt="award" width="132" height="103">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-7.png" alt="award" width="132" height="103">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2017</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 col-lg-4 fade-anim" data-delay="0.60" data-direction="right">
                <div class="award-box-style1">
                    <div class="award-box-style1-wrapper">
                        <figure class="award-box-icon text-center">
                            <img src="home/img/awards/award-9.png" alt="award" width="132" height="103">
                        </figure>
                        <div
                            class="award-box-header d-flex align-items-end justify-content-between gap-xl-4 text-center">
                            <img src="home/img/awards/award-box-left-wings.png" alt="award-box-left-wings" />
                        ...
                        <div class="award-box-footer text-capitalize text-center">
                            <p class="line1">
                                recived award in <strong>2016</strong>
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-auto mx-auto">
                <div class="title-area text-center">
                    ...
                    <h2 class="sec-title text-white-color fade-anim" data-direction="bottom">
                        Celebrating Excellence in Advisory Leadership
                    </h2>
                    <p class="mt-5 fs-5 text-white">"Honoring visionaries who inspire, lead, and transform the
                        world of advisory services."</p>
                </div>
            </div>
        </div>
