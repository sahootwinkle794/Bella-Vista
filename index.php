<?php include 'header-one.php'; ?>
 ...
 <!--================= Header Area end =================-->
    ...
    <div class="vs-services-style1 space bg-second-theme-color"
      data-bg-src="home/img/services/vs-services-style1-bg.png">
            ...
            <div class="swiper room-type-slider">
              <div class="swiper-wrapper">
                ...
                <div class="swiper-slide">
                  <div class="destination-box">
                    <div class="destination-thumb">
                      <img src="https://www.bellavistaresort.com/images/forest-executive-room/forest-executive-room-05.jpg" alt="destination" class="w-100" />
                    </div>
                    <div class="destination-content">
                      <div class="info">
                        <h4 class="text-white text-capitalize">
