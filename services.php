      ...
      <section class="service-one">
        <div class="auto-container">
          ...
          <div class="inner-container">
            ...
            <!-- <span class="sec-subtitle fade-anim" data-direction="top">Explore Our Menus</span> -->
            <h2 class="sec-title move-anim">Explore Our Menus
            </h2>
          </div>
            <div class="row row-cols-5 clearfix text-center">
