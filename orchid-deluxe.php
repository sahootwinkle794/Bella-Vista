        ...
        <div class="row text-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-title">Orchid Deluxe (1st and 2nd floor)</h1>
                </div>
                <div class="breadcrumb-menu">
                    <ul class="custom-ul">
                        ...
                        <li>Orchid Deluxe (1st and 2nd floor)</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row align-items-center gy-3 mb-4">
                        <div class="col-8 col-sm-12">
                            <h2 class="destination-single-title">
                                Orchid Deluxe (1st and 2nd floor)
                            </h2>
                        </div>
                    </div>
                    <div class="destination-single-info">
                        ...
                        <div class="destination-single-px">
                            ...
                            <div id="current" class="tab-content active">
                                ...
                                <p> Elegant decor meets plush furnishings in this classic hotel room fitted with
                                    spacious balconies offering views of the children’s park or tree-canopied backyard.
                                    Located on both first and second floors. </p>
                            </div>
                                ...
                                <div class="trip-info">
                                    ...
                                    <div class="trip-info-box">
                                        <div class="header"> <img src="home/img/icons/service-2.png" alt="service">
                                            <span class="info-title">Hot and Cold Air Conditioning</span>
                                        </div>
                                    </div>
                                    <div class="trip-info-box">
          ...
          <div class="inner-container">
            <div class="row clearfix">
              ...
              <div class="column col-lg-5 col-md-12 col-sm-12 ">
                ...
                <div class="about-three_image img-reveal overlay-anim room-img">
                  <img src="home/img/destination/orchid/img-2.jpeg" alt="" />
                </div>
               
                
                <div class="room-dott about-three_dotted" style="background-image:url(assets/images/main-slider/dotted.png)">
                </div>
              </div>
              <!-- Column -->
          ...
          <div class="inner-container">
            <div class="row clearfix">
              ...
              <div class="column col-lg-5 col-md-12 col-sm-12 ">
                ...
                <div class="about-three_image img-reveal overlay-anim room-img room-img-right">
                  <img src="home/img/destination/orchid/img-2.jpeg" alt="" />
                </div>
