        ...
        <div class="row text-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-title">APARTMENT WING 1ST FLOOR</h1>
                </div>
                        ...
                        <div class="destination-single-px">
                            ...
                            <div id="dimensions" class="tab-content">
                                ...
                                <div class="trip-info">
                                    ...
                                    <div class="trip-info-box">
                                        <div class="header"> <img src="home/img/icons/service-20.png" alt="service">
                                            <span class="info-title">Attic floor: 90 sq
                                                feet</span>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="owl-carousel owl-theme owl-loaded owl-drag">
                            ...
                            <div class="owl-stage-outer">
                                <div class="owl-stage"
                                    ...
                                    <div class="owl-item cloned" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-2.jpeg" alt="">
                                        </div>
                                    </div>

                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-3.jpeg" alt="">
                                        </div>
                                    </div>

                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-4.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-5.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-6.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-7.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-8.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-9.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-10.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/apartment/img-11.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
