        ...
        <div class="row text-center">
            <div class="col-12">
                <div class="breadcrumb-content">
                    <h1 class="breadcrumb-title">VALLEY DELUXE ROOM</h1>
                </div>
                    ...
                    <div class="destination-single-info">
                        <div class="owl-carousel owl-theme owl-loaded owl-drag">
                            ...
                            <div class="owl-stage-outer">
                                <div class="owl-stage"
                                    ...
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-22.jpeg" alt="">
                                        </div>
                                    </div>
                                   <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-23.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-24.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-25.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-26.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-27.jpeg" alt="">
                                        </div>
                                    </div>
                                    <div class="owl-item" style="width: 128.906px; margin-right: 10px;">
                                        <div class="item">
                                            <img src="home/img/destination/red-stone/valley-28.jpeg" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <button class="super-button btn mt-3" data-bs-toggle="modal" data-bs-target="#valley-deluxe-modal">
                        ...
                        <div class="destination-single-px">
                            ...
                            <div id="current" class="tab-content active">
                                <p> Red Stone Wing features tastefully designed rooms that blend style with comfort.
                                    Each room opens to a spacious private balcony, offering captivating views of the
                                    picturesque Lingmala red and the lush green lawns just below. It’s the perfect
                                    setting to unwind and soak in the serene beauty of Mahabaleshwar.</p>
                            </div>
