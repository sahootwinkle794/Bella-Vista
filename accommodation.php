    ...
    <div class="row text-center">
      <div class="col-12">
        <div class="breadcrumb-content">
          <h1 class="breadcrumb-title">Accomodation</h1>
        </div>
...
<section class="rooms-three style-two">
  <h4 class="text-center accom-head">The relaxing accommodation is spread across 4 acres of landscape in 3 blocks,
    consisting of a wide variety of rooms to choose from.</h4>
      ...
      <div class="row">
        <div class="col-md-4">
          <div class="room-block_two">
            <div class="room-block_two-inner card">
          ...
          <div class="room-block_two">
            <div class="room-block_two-inner card">
              ...
              <div class="room-block_two-content">
                ...
                <h3 class="room-block_two-title"><a href="javascript:void(0);">RED STONE WING</a></h3>
                ...
                <!-- <div class="room-block_two-tag mt-2"><a href="deluxeroom.php">Deluxe</a></div>
                <div class="room-block_two-tag"><a href="valleydeluxe.php">Valley Deluxe</a></div>
                <div class="room-block_two-tag"><a href="premiumroom.php">Premium</a></div> -->
        ...
        <div class="col-md-4">
          <div class="room-block_two">
            <div class="room-block_two-inner card">
              ...
              <div class="room-block_two-content">
                <!-- <div class="room-block_two-price">980$ <span>Night</span></div> -->
                <h3 class="room-block_two-title"><a href="javascript:void(0);">APARTMENT WING</a></h3>
                ...
                <!-- <div class="room-block_two-tag mt-2"><a href="ground-floor.php">Ground Floor</a></div>
                <div class="room-block_two-tag"><a href="1st-floor.php">1st Floor </a></div> -->
